...
fn create_new_task() -> Result<Task> {
    ...
    Ok(create_new_task_from_str(title, client, date).unwrap())
}

fn create_new_task_from_str(title: String, client: String, date: String) -> Result<Task> {
    ...
    W: Write,
{
    ...
    loop {
        ...
        add_list(&lst_task, create_new_task_from_str(name, client, date).unwrap(), path.to_path_buf());
